...
**Difficulty:** Hard  
[View on LeetCode](https://leetcode.com/problems/count-the-number-of-inversions/)
...
- Prefix `[2, 0, 1]` has inversions `(0, 1)` and `(0, 2)`. - Prefix `[2]` has 0 inversions.

- `[1, 2, 0]` - Prefix `[1, 2, 0]` has inversions `(0, 2)` and `(1, 2)`. - Prefix `[1]` has 0 inversions.
