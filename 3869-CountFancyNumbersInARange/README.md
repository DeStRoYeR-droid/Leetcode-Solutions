...
**Difficulty:** Hard  
[View on LeetCode](https://leetcode.com/problems/count-fancy-numbers-in-a-range/)
...
- 12340 is not good because `[1, 2, 3, 4, 0]` is not strictly monotone. - The digit sum is `1 + 2 + 3 + 4 + 0 = 10`. - 10 is good as it has digits `[1, 0]`, which is strictly decreasing. Therefore, 12340 is fancy.

- 12341 - 12341 is not good because `[1, 2, 3, 4, 1]` is not strictly monotone. - The digit sum is `1 + 2 + 3 + 4 + 1 = 11`. - 11 is not good as it has digits `[1, 1]`, which is not strictly monotone. Therefore, 12341 is not fancy.
